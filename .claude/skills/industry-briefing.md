...
六大核心行业（AI / 教育 / 家居建材 / 汽车 / 金融 / 通信）使用 3 列表格：

```
## 行业名 (N篇)
| 公众号 | 发布时间 | 标题 |
|--------|---------|------|
| 公众号A | 2026-05-19 15:30 | [文章标题](https://mp.weixin.qq.com/s/xxx) |
| 公众号B | 2026-05-18 10:00 | [文章标题](https://mp.weixin.qq.com/s/yyy) |
```

「其他」类目使用 4 列表格，在发布时间后追加"涉及行业"列：
...
**低置信度标记**：内容为空的文章，在"涉及行业"标签后加 `†`（其他类目）或标题后加 `†`（六大行业类目）。每个存在低置信度文章的分类在其表格下方加脚注：
